                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item active"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Categories <span class="badge"><?php echo $total_categories; ?></span></a>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div><strong>Do you want to delete this category</strong></div> 
                        </div>
                        <div id="btns">
            ...
            <div id="del_success" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div><strong>You successfully deleted the category</strong></div> 
                        </div>
                        <div id="btns">
                        ...
                        <div class="modal-body">
                            <form id="edit_cat_form" method="post" >
                                <div class="form-group" id="edit_value">
                                    ...
                                    <input name="name" id="name" type="text" class="form-control" placeholder="Enter Name" value="" required>
                                </div>
                                <button id="edit_cat" type="submit" class="btn btn-danger" name="cmt">Edit</button>
                            </form>
                        </div>
